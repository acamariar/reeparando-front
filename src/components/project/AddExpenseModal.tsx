...
export default function AddExpenseModal({ open, onClose, projectId, categories = ["Materiales", "Mano de Obra", "Equipo", "traslado", "Otros", "Contrafactura", "ContrafacturaPagada"], initialValues }: Props) {
